...
class PyKinectRuntime(object):
    ...
    def __init__(self, frame_source_types):
        ...
        self._raw_color_image_format = None
        self._depth_min_distance = None
        self._depth_max_distance = None
    ...
    def get_raw_color_image_format(self):
        if self._raw_color_image_format is not None:
            return PyKinectRuntime.ColorImageFormat(self._raw_color_image_format)
        return None
		
    def get_depth_min_distance(self):
        return self._depth_min_distance
		
    def get_depth_max_distance(self):
        return self._depth_max_distance
        ...
        try:
            ...
            try:
                with self._color_frame_lock:
                    ...
                    self._raw_color_image_format = colorFrame.RawColorImageFormat
        ...
        try:
            ...
            try:
                with self._depth_frame_lock:
                    ...
                    self._depth_max_distance = depthFrame.DepthMaxReliableDistance
                    self._depth_min_distance = depthFrame.DepthMinReliableDistance
